...
// File Options
var saveCurrentFile = true //true or false [default = true]
var closeAfterSave = true //true or false [default = true]
...
for (var file in fileList) {
  ...
  //for (var i = 0; i < fileList.length; i++) {
    ...
    var newPsdName = File(newPsdPath + psdName + newFileSuffix + ".psd");
...
/*
|  saveFileAsPSD(filePath)
|  - save the psd file
*/

function saveFileAsPSD(filePath) {
  ...
  app.activeDocument.saveAs(filePath, psdSaveOptions, true, Extension.LOWERCASE);
  };